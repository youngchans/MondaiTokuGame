...
class QuestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quest" do
    assert_difference("Quest.count") do
      post quests_url, params: { quest: { description: @quest.description, question: @quest.question, wrong_f: @quest.wrong_f, wrong_s: @quest.wrong_s } }
    end
  ...
  test "should update quest" do
    patch quest_url(@quest), params: { quest: { description: @quest.description, question: @quest.question, wrong_f: @quest.wrong_f, wrong_s: @quest.wrong_s } }
